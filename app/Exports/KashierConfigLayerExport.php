...
use App\Models\KashierConfigLayer;
...
class KashierConfigLayerExport implements WithMapping, WithHeadings,FromQuery
{

    public function query()
    {
        $provider_services=KashierConfigLayer::query();
        if(request('IDS')){
