...
{{--    <link rel="stylesheet" href="{{ asset('assets/css/dark-theme.css') }}" />--}}
    ...
    <link rel="stylesheet" href="{{ asset('assets/plugins/bootstrap4-editable/css/bootstrap-editable.css') }}" />
    <!-- Scripts -->
    @vite(['resources/sass/dashboard_app.scss', 'resources/js/dashboard_app.js'])
    <style>
        .loading {
            position: relative;
        }
        ...
        .top-header a.dropdown-item div.media > div.notify{
...
{{--    <script src="{{ asset('assets/js/app.js?v=1.0.0.0.0.0.0') }}"></script>--}}
    ...
    @vite(['resources/js/dashboard_app_footer.js'])
    <script>
        feather.replace();
