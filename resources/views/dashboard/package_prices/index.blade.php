    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-md-flex align-items-center mb-3">
                <div class="breadcrumb-title pr-3">{{ __('Package Prices') }}</div>
                <div class="pl-3">
                ...
                <div class="ml-auto">
                    ...
                    @endif
                    @if (PerUser('package_prices.create'))
                        <a href="{{ route('package_prices.create') }}" class="btn btn-primary"><i
            ...
            <div class="card radius-15">
                ...
                <div class="card-body">
                    <div class="card-title">
                        <h4 class="mb-0">{{ __('Package Prices') }}</h4>
                    </div>
        ...
        $(document).on('click', '.delete-selected', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('package_prices.multi_destroy') }}",
                        data: {
                            IDS
                        },
